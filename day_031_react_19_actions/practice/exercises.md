...
Use this worksheet after reading [the lesson](../day_031_react_19_actions.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **React 19 Actions** and uses only local, synthetic, bounded data.
