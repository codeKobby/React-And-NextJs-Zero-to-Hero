...
Use these only after attempting the numbered exercises in [the lesson](../day_031_react_19_actions.md). They are specific to **React 19 Actions** and should unblock the next thought without replacing it.

## Hints

1. Read the short problem statement for react 19 actions and say what the page or program should do.
...
4. Change one input for What is an Action?. Keep every other line the same.
5. For Why do mutations need pending and error state?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try How do Actions compose with transitions?.
