...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_031_react_19_actions.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is an Action?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is an Action?** and **Why do mutations need pending and error state?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
