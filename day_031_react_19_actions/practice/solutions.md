...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_031_react_19_actions.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is an Action?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why do mutations need pending and error state?**.
...
7. The comparison table distinguishes **What is an Action?** from **Why do mutations need pending and error state?** by responsibility, lifetime, and direction of data flow.
