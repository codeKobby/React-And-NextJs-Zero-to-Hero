...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_005_tooling_and_the_first_component.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What does a toolchain do?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What does a toolchain do?** and **What is a React component?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
