...
4. Change exactly one input related to What does a toolchain do?; keep the rule fixed.
5. For What is a React component?, decide the normal and boundary behavior before coding.
...
8. Keep the data local and synthetic while you test How does JSX become browser output?.
9. Assert a visible result or public contract rather than a private implementation detail.
10. Use the same fixture to apply tooling and the first component to a local case dashboard built from a shell, summary, list, and card.
