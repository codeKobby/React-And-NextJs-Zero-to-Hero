...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_005_tooling_and_the_first_component.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What does a toolchain do?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What is a React component?**.
...
7. The comparison table distinguishes **What does a toolchain do?** from **What is a React component?** by responsibility, lifetime, and direction of data flow.
