...
Use this worksheet after reading [the lesson](../day_005_tooling_and_the_first_component.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Tooling and the first component** and uses only local, synthetic, bounded data.
