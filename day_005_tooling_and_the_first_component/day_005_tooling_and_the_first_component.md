...
| --- | --- |
| `package.json` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `bundler` | A term you will use in this lesson; test it in the examples before memorizing it. |
...
| `dev server` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What does a toolchain do?

Start with the ordinary-language question: **What does a toolchain do?**. In **Tooling and the first component**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **What is a React component?**. In **Tooling and the first component**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How does JSX become browser output?

Start with the ordinary-language question: **How does JSX become browser output?**. In **Tooling and the first component**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we verify a first component?

Start with the ordinary-language question: **How do we verify a first component?**. In **Tooling and the first component**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
