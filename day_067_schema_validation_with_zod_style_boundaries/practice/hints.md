...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_067_schema_validation_with_zod_style_boundaries.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **Why validate at a boundary?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **Why validate at a boundary?** and **What is the difference between parse and safeParse?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
