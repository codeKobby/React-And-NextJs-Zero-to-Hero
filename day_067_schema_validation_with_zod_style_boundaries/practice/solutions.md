...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_067_schema_validation_with_zod_style_boundaries.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **Why validate at a boundary?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What is the difference between parse and safeParse?**.
...
7. The comparison table distinguishes **Why validate at a boundary?** from **What is the difference between parse and safeParse?** by responsibility, lifetime, and direction of data flow.
