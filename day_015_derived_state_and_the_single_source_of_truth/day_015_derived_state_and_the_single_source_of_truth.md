...
| --- | --- |
| `derived value` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `source of truth` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `duplication` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `selector` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `invariant` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is derived state?

Start with the ordinary-language question: **What is derived state?**. In **Derived state and the single source of truth**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why should we avoid storing what can be calculated?**. In **Derived state and the single source of truth**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What is one source of truth?

Start with the ordinary-language question: **What is one source of truth?**. In **Derived state and the single source of truth**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do selectors simplify state?

Start with the ordinary-language question: **How do selectors simplify state?**. In **Derived state and the single source of truth**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
