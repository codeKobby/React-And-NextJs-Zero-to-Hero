...
Use this worksheet after reading [the lesson](../day_015_derived_state_and_the_single_source_of_truth.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Derived state and the single source of truth** and uses only local, synthetic, bounded data.
