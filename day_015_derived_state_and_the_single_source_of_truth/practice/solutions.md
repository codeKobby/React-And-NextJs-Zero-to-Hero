...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_015_derived_state_and_the_single_source_of_truth.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is derived state?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why should we avoid storing what can be calculated?**.
...
7. The comparison table distinguishes **What is derived state?** from **Why should we avoid storing what can be calculated?** by responsibility, lifetime, and direction of data flow.
