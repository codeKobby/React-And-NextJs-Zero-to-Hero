...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_015_derived_state_and_the_single_source_of_truth.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is derived state?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is derived state?** and **Why should we avoid storing what can be calculated?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
