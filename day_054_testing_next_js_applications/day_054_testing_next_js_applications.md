...
| --- | --- |
| `unit test` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `integration test` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `E2E` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `route handler` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `fixture` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `mock` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What should be tested at each level?

Start with the ordinary-language question: **What should be tested at each level?**. In **Testing Next.js applications**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **How do we test a Server Action?**. In **Testing Next.js applications**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What is a safe fixture?

Start with the ordinary-language question: **What is a safe fixture?**. In **Testing Next.js applications**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### When is a browser test valuable?

Start with the ordinary-language question: **When is a browser test valuable?**. In **Testing Next.js applications**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
