...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_054_testing_next_js_applications.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What should be tested at each level?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What should be tested at each level?** and **How do we test a Server Action?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
