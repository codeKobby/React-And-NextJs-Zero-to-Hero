...
Use these after attempting the [exercises](exercises.md). They are specific to **Testing Next.js applications** and should unblock the next thought without replacing it.
