...
Use this worksheet after reading [the lesson](../day_054_testing_next_js_applications.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Testing Next.js applications** and uses only local, synthetic, bounded data.
