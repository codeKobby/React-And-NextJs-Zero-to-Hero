...
Use this worksheet after reading [the lesson](../day_058_migration_from_pages_router_and_old_react.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Migration from Pages Router and old React** and uses only local, synthetic, bounded data.
