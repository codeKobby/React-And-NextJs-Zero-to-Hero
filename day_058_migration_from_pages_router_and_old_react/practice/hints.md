...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_058_migration_from_pages_router_and_old_react.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is legacy?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is legacy?** and **How do Pages Router data functions map to App Router?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
