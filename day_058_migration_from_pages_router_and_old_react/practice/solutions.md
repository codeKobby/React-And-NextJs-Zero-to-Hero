...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_058_migration_from_pages_router_and_old_react.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is legacy?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **How do Pages Router data functions map to App Router?**.
...
7. The comparison table distinguishes **What is legacy?** from **How do Pages Router data functions map to App Router?** by responsibility, lifetime, and direction of data flow.
