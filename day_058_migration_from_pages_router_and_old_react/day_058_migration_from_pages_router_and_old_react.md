...
By the end, you should be able to explain the main idea in your own words, show the normal and broken behavior, trace the important values, predict a boundary result, and apply **migration from pages router and old react** to a small local fixture that demonstrates migration from pages router and old react. You should be able to name the owner and boundary—the code or framework boundary that owns the decision in this lesson—and state what the example does not prove about production readiness, security, accessibility, performance, or correctness.
...
Start with the learner's concrete question: **What is legacy**. Use the worked example to show what **What is legacy** changes before introducing a framework shortcut. For **What is legacy**, point to the smallest value, element, function, route, or boundary that demonstrates the answer. Keep the conclusion limited to the local evidence for **What is legacy**; a small fixture cannot prove production security, accessibility, performance, or correctness.

**Try it before moving on:** For **What is legacy?**, point to the exact line or file where this idea appears, then explain its input, visible result, and owner in your own words.

### How do Pages Router data functions map to App Router?

To answer **How do Pages Router data functions map to App Router**, follow the operation in order rather than treating the result as framework magic. For **How do Pages Router data functions map to App Router**, write the input, the operation that changes it, the output, and the boundary that is responsible. Keep the conclusion limited to the local evidence for **How do Pages Router data functions map to App Router**; a small fixture cannot prove production security, accessibility, performance, or correctness.

**Try it before moving on:** For **How do Pages Router data functions map to App Router?**, change one input or boundary in the worked example. Trace the result for **How do Pages Router data functions map to App Router?** and identify which owner is responsible for the new behavior; record the concrete value or file that changed.

### How do class lifecycles map to Hooks?

To answer **How do class lifecycles map to Hooks**, follow the operation in order rather than treating the result as framework magic. For **How do class lifecycles map to Hooks**, write the input, the operation that changes it, the output, and the boundary that is responsible. Keep the conclusion limited to the local evidence for **How do class lifecycles map to Hooks**; a small fixture cannot prove production security, accessibility, performance, or correctness.

**Try it before moving on:** For **How do class lifecycles map to Hooks?**, change one input or boundary in the worked example. Trace the result for **How do class lifecycles map to Hooks?** and identify which owner is responsible for the new behavior; record the concrete value or file that changed.

### How do we migrate incrementally?

To answer **How do we migrate incrementally**, follow the operation in order rather than treating the result as framework magic. For **How do we migrate incrementally**, write the input, the operation that changes it, the output, and the boundary that is responsible. Keep the conclusion limited to the local evidence for **How do we migrate incrementally**; a small fixture cannot prove production security, accessibility, performance, or correctness.

**Try it before moving on:** For **How do we migrate incrementally?**, change one input or boundary in the worked example. Trace the result for **How do we migrate incrementally?** and identify which owner is responsible for the new behavior; record the concrete value or file that changed.
...
| ---: | --- |
| 1 | `pages/index.tsx -> app/page.tsx` — Runs inside the current example; connect its effect to the code or framework boundary that owns the decision in this lesson. |
| 2 | `getServerSideProps -> async Server Component data access` — Runs inside the current example; connect its effect to the code or framework boundary that owns the decision in this lesson. |

Use the table as a starting point, not as a substitute for running the code. Add a note beside any line whose behavior differs between a browser, React, and Next.js server environment.

## Execution trace

1. Start with the fixture's initial input: Learners need a concrete reason to study migration from pages router and old react before the terminology becomes useful.
...
Before running the experiment, write your prediction. Change exactly one input or boundary related to **Migration from Pages Router and old React**. Use a normal alternative first, then a boundary such as an empty value, invalid value, loading condition, missing route parameter, rejected action, unauthorized actor, or reordered record when it fits the lesson. Predict the visible output or error, run it, and explain the difference. Restore the original case to prove the repair preserved the normal behavior.
...
10. Apply the lesson to a small local fixture that demonstrates migration from pages router and old react and document the route map.
...
You are finished when you can teach **Migration from Pages Router and old React** to another beginner, show the normal and broken runs, explain the repair, and point to **the code or framework boundary that owns the decision in this lesson**. You should be able to name one limitation and one piece of evidence that would be required before making a production claim. Do not move on because the code merely compiles.
