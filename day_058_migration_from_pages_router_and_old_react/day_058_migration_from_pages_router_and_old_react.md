...
| --- | --- |
| `Pages Router` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `App Router` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `getServerSideProps` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `getStaticProps` | A term you will use in this lesson; test it in the examples before memorizing it. |
...
Start with the ordinary-language question: **How do Pages Router data functions map to App Router?**. In **Migration from Pages Router and old React**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do class lifecycles map to Hooks?

Start with the ordinary-language question: **How do class lifecycles map to Hooks?**. In **Migration from Pages Router and old React**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we migrate incrementally?

Start with the ordinary-language question: **How do we migrate incrementally?**. In **Migration from Pages Router and old React**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
