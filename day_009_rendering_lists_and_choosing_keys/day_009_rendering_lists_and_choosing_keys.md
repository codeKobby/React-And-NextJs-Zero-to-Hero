...
| `key` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `identity` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `reconciliation` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `stable ID` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### How do we render a list?

Start with the ordinary-language question: **How do we render a list?**. In **Rendering lists and choosing keys**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **What is a key?**. In **Rendering lists and choosing keys**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Why is array index a risky key?

Start with the ordinary-language question: **Why is array index a risky key?**. In **Rendering lists and choosing keys**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do stable identities prevent UI mistakes?

Start with the ordinary-language question: **How do stable identities prevent UI mistakes?**. In **Rendering lists and choosing keys**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
