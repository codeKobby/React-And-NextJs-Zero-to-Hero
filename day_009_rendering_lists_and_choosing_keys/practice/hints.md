...
Use these after attempting the [exercises](exercises.md). They are specific to **Rendering lists and choosing keys** and should unblock the next thought without replacing it.
