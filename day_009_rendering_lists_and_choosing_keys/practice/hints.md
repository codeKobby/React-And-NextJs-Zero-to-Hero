...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_009_rendering_lists_and_choosing_keys.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How do we render a list?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How do we render a list?** and **What is a key?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
