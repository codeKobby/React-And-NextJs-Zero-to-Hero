...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_060_final_demonstration_and_portfolio_review.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What makes a project demonstrable?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **How do we explain the architecture to another person?**.
...
7. The comparison table distinguishes **What makes a project demonstrable?** from **How do we explain the architecture to another person?** by responsibility, lifetime, and direction of data flow.
