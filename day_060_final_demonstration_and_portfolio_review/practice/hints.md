...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_060_final_demonstration_and_portfolio_review.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What makes a project demonstrable?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What makes a project demonstrable?** and **How do we explain the architecture to another person?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
