...
| --- | --- |
| `demonstration` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `portfolio` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `README` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `architecture decision` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `evidence` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `residual risk` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What makes a project demonstrable?

Start with the ordinary-language question: **What makes a project demonstrable?**. In **Final demonstration and portfolio review**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **How do we explain the architecture to another person?**. In **Final demonstration and portfolio review**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What evidence belongs in a portfolio?

Start with the ordinary-language question: **What evidence belongs in a portfolio?**. In **Final demonstration and portfolio review**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we state residual risk honestly?

Start with the ordinary-language question: **How do we state residual risk honestly?**. In **Final demonstration and portfolio review**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
