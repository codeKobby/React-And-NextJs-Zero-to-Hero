...
To answer **How do we explain the architecture to another person**, follow the operation in order and check the example. For **How do we explain the architecture to another person**, write the starting value, the change you made, and the new result.
...
To answer **How do we state residual risk honestly**, follow the operation in order and check the example. For **How do we state residual risk honestly**, write the starting value, the change you made, and the new result.
...
5. Use an empty list, empty string, or missing value that fits **What evidence belongs in a portfolio?**. Say what should happen.
