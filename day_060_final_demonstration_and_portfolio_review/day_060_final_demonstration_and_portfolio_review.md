# Day 060: Final demonstration and portfolio review

[← Previous lesson](../day_059_capstone_architecture_and_review/day_059_capstone_architecture_and_review.md) · [Start here](../README.md) · [Setup](../SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_061_getters_setters_and_state_boundaries/day_061_getters_setters_and_state_boundaries.md)
...
- [Topics](#topics)
  - [What makes a project demonstrable?](#what-makes-a-project-demonstrable)
  - [How do we explain the architecture to another person?](#how-do-we-explain-the-architecture-to-another-person)
  - [What evidence belongs in a portfolio?](#what-evidence-belongs-in-a-portfolio)
  - [How do we state residual risk honestly?](#how-do-we-state-residual-risk-honestly)
...
Here is the problem: The learner needs to see what final demonstration and portfolio review does before learning its name.

A small workshop task lets the learner change one thing and see the result.

Today we will learn **Final demonstration and portfolio review** in small steps. We will run a small example, change one input, look at the result, make a common mistake, fix it, and try one small variation. You are learning what the code does, not just memorising a word.
...
- explain **Final demonstration and portfolio review** in your own words;
- run the normal example;
- show the broken example and fix it;
- change one input and predict the result; and
- use **final demonstration and portfolio review** in a small local example.
...
Start with the learner's concrete question: **What makes a project demonstrable**. Look at **What makes a project demonstrable** in the example before learning the technical name. For **What makes a project demonstrable**, point to the smallest value, element, function, or route that shows the answer.

**Try it before moving on:** For **What makes a project demonstrable**, say what goes in and what comes out.

### How do we explain the architecture to another person?

To answer **How do we explain the architecture to another person**, follow the operation in order rather than treating the result as framework magic. For **How do we explain the architecture to another person**, write the starting value, the change you made, and the new result.

**Try it before moving on:** For **How do we explain the architecture to another person**, change one input in the example. Write the old result and the new result for **How do we explain the architecture to another person**.

### What evidence belongs in a portfolio?

Start with the learner's concrete question: **What evidence belongs in a portfolio**. Look at **What evidence belongs in a portfolio** in the example before learning the technical name. For **What evidence belongs in a portfolio**, point to the smallest value, element, function, or route that shows the answer.

**Try it before moving on:** For **What evidence belongs in a portfolio**, say what goes in and what comes out.

### How do we state residual risk honestly?

To answer **How do we state residual risk honestly**, follow the operation in order rather than treating the result as framework magic. For **How do we state residual risk honestly**, write the starting value, the change you made, and the new result.

**Try it before moving on:** For **How do we state residual risk honestly**, change one input in the example. Write the old result and the new result for **How do we state residual risk honestly**.
...
```tsx
const evidence = { build: 'pass', tests: 'pass', accessibility: 'reviewed' };
...
```text
The review records evidence and remaining uncertainty.
```
...
| ---: | --- |
| 1 | `const evidence = { build: 'pass', tests: 'pass', accessibility: 'reviewed' };` — Stores the value on the right under the name on the left. |
| 2 | `console.log(evidence);` — Prints a value so you can compare the result with your prediction. |
...
1. Write down the starting value: The learner needs to see what final demonstration and portfolio review does before learning its name.
...
4. Use the same starter for **final demonstration and portfolio review** and a small local example.
...
1. Answer the question **What makes a project demonstrable?** in one sentence. Point to the example that helped you.
2. Run the example unchanged. Write down what appears.
3. Change one value. Predict the result, then run the code and compare.
4. Change one input in the example for **How do we explain the architecture to another person?**. Write down the old and new result.
5. Add one simple edge case for **What evidence belongs in a portfolio?**, such as an empty or invalid value.
6. Make the mistake shown in the lesson: Claim that passing tests prove production readiness and repair the claim with explicit limits.
...
1. explain **Final demonstration and portfolio review** to another beginner;
