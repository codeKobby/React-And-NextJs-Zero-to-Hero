...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_044_loading_error_and_not_found_ui.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What should users see while data loads?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What does error.tsx catch?**.
...
7. The comparison table distinguishes **What should users see while data loads?** from **What does error.tsx catch?** by responsibility, lifetime, and direction of data flow.
