...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_044_loading_error_and_not_found_ui.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What should users see while data loads?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What should users see while data loads?** and **What does error.tsx catch?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
