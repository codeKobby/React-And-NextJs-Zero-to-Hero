...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_026_suspense_and_the_use_api.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What does Suspense coordinate?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What does Suspense coordinate?** and **What is a fallback?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
