...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_026_suspense_and_the_use_api.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What does Suspense coordinate?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What is a fallback?**.
...
7. The comparison table distinguishes **What does Suspense coordinate?** from **What is a fallback?** by responsibility, lifetime, and direction of data flow.
