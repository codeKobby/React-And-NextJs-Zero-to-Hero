...
To answer **How does use read a promise**, follow the operation in order and check the example. For **How does use read a promise**, write the starting value, the change you made, and the new result.
...
5. Use an empty list, empty string, or missing value that fits **How does use read a promise?**. Say what should happen.
