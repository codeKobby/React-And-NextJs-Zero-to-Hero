...
Use this guide after attempting [the exercises](exercises.md). It reviews the decisions for **shadcn/ui composition, theming, and accessible patterns**; it is not a copied answer key.
