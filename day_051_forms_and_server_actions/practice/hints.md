...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_051_forms_and_server_actions.md) and [setup guide](../../SETUP.md) first.
...
7. **What is a Server Action?** and **How does a form call server code?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
