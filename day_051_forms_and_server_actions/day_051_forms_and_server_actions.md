...
| --- | --- |
| `Server Action` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `use server` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `FormData` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `mutation` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `revalidatePath` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `redirect` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a Server Action?

Start with the ordinary-language question: **What is a Server Action?**. In **Forms and Server Actions**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **How does a form call server code?**. In **Forms and Server Actions**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Where does validation happen?

Start with the ordinary-language question: **Where does validation happen?**. In **Forms and Server Actions**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we revalidate after mutation?

Start with the ordinary-language question: **How do we revalidate after mutation?**. In **Forms and Server Actions**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
