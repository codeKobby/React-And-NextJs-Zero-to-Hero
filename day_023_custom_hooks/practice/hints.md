...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_023_custom_hooks.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is a custom Hook?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is a custom Hook?** and **Which logic belongs in a Hook?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
