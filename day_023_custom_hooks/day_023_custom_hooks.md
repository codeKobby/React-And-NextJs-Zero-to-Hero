...
| --- | --- |
| `custom Hook` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `reuse` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `hook rules` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `composition` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `return API` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a custom Hook?

Start with the ordinary-language question: **What is a custom Hook?**. In **Custom Hooks**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Which logic belongs in a Hook?**. In **Custom Hooks**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Why must Hook names begin with use?

Start with the ordinary-language question: **Why must Hook names begin with use?**. In **Custom Hooks**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we design a small return API?

Start with the ordinary-language question: **How do we design a small return API?**. In **Custom Hooks**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
