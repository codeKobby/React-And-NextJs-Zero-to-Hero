...
Use this worksheet after reading [the lesson](../day_046_server_and_client_components.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Server and Client Components** and uses only local, synthetic, bounded data.
