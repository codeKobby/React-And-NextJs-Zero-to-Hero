...
| --- | --- |
| `Server Component` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `Client Component` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `use client` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `serializable props` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `module graph` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### Which components are Server by default?

Start with the ordinary-language question: **Which components are Server by default?**. In **Server and Client Components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **When is use client required?**. In **Server and Client Components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What props can cross the boundary?

Start with the ordinary-language question: **What props can cross the boundary?**. In **Server and Client Components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we keep the client bundle small?

Start with the ordinary-language question: **How do we keep the client bundle small?**. In **Server and Client Components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
