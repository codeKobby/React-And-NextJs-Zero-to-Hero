...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_018_lifting_state_up.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **When should state move to a parent?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **When should state move to a parent?** and **How do siblings share state?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
