...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_062_tailwind_css_v4_setup_in_next_js.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What problem does Tailwind CSS solve?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What problem does Tailwind CSS solve?** and **How does Tailwind CSS v4 enter a Next.js project?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
