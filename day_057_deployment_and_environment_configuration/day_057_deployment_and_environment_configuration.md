...
| --- | --- |
| `build` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `start` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `environment variable` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `secret` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `runtime` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `CI` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is the production build?

Start with the ordinary-language question: **What is the production build?**. In **Deployment and environment configuration**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Which variables are public?**. In **Deployment and environment configuration**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Where do secrets live?

Start with the ordinary-language question: **Where do secrets live?**. In **Deployment and environment configuration**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What should CI prove before deployment?

Start with the ordinary-language question: **What should CI prove before deployment?**. In **Deployment and environment configuration**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
