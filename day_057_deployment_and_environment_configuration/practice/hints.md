...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_057_deployment_and_environment_configuration.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is the production build?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is the production build?** and **Which variables are public?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
