...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_021_what_is_useeffect.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is an Effect?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why is it for synchronization rather than ordinary calculations?**.
...
7. The comparison table distinguishes **What is an Effect?** from **Why is it for synchronization rather than ordinary calculations?** by responsibility, lifetime, and direction of data flow.
