...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_021_what_is_useeffect.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is an Effect?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is an Effect?** and **Why is it for synchronization rather than ordinary calculations?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
