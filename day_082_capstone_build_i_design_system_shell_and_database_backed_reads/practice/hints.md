...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_082_capstone_build_i_design_system_shell_and_database_backed_reads.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How do we turn the plan into a vertical slice?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How do we turn the plan into a vertical slice?** and **Which UI primitives should be shared?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
