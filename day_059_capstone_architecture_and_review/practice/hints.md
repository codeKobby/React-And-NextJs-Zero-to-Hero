...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_059_capstone_architecture_and_review.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How do we design a real app?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How do we design a real app?** and **Where do routes, components, data, and policies live?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
