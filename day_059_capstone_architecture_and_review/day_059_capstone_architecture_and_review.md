...
| --- | --- |
| `architecture` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `feature boundary` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `threat model` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `test plan` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `observability` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `trade-off` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### How do we design a real app?

Start with the ordinary-language question: **How do we design a real app?**. In **Capstone architecture and review**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Where do routes, components, data, and policies live?**. In **Capstone architecture and review**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we document trade-offs?

Start with the ordinary-language question: **How do we document trade-offs?**. In **Capstone architecture and review**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What evidence proves readiness?

Start with the ordinary-language question: **What evidence proves readiness?**. In **Capstone architecture and review**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
