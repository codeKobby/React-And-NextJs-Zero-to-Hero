...
To answer **How do we design a real app**, follow the operation in order and check the example. For **How do we design a real app**, write the starting value, the change you made, and the new result.
...
To answer **How do we document trade-offs**, follow the operation in order and check the example. For **How do we document trade-offs**, write the starting value, the change you made, and the new result.
...
5. Use an empty list, empty string, or missing value that fits **How do we document trade-offs?**. Say what should happen.
