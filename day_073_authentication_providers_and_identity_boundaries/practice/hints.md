...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_073_authentication_providers_and_identity_boundaries.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is authentication?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is authentication?** and **What belongs to an authentication provider?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
