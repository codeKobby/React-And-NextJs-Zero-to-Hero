...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_073_authentication_providers_and_identity_boundaries.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is authentication?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What belongs to an authentication provider?**.
...
7. The comparison table distinguishes **What is authentication?** from **What belongs to an authentication provider?** by responsibility, lifetime, and direction of data flow.
