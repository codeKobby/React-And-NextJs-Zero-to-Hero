...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_035_react_architecture_and_accessibility.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How do we choose component boundaries?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How do we choose component boundaries?** and **What does semantic HTML provide?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
