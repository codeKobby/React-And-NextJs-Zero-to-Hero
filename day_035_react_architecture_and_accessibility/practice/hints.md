...
1. Read the short problem statement for react architecture and accessibility and say what the page or program should do.
...
4. Change one input for How do we choose component boundaries?. Keep every other line the same.
5. For What does semantic HTML provide?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try When is ARIA needed?.
