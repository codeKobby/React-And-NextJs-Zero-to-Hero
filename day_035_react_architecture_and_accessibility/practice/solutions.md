...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_035_react_architecture_and_accessibility.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **How do we choose component boundaries?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What does semantic HTML provide?**.
...
7. The comparison table distinguishes **How do we choose component boundaries?** from **What does semantic HTML provide?** by responsibility, lifetime, and direction of data flow.
