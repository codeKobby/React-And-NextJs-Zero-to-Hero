...
Use this worksheet after reading [the lesson](../day_035_react_architecture_and_accessibility.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **React architecture and accessibility** and uses only local, synthetic, bounded data.
