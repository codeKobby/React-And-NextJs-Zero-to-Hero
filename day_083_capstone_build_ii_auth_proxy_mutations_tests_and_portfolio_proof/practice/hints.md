...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_083_capstone_build_ii_auth_proxy_mutations_tests_and_portfolio_proof.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How do we connect identity to protected mutations?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How do we connect identity to protected mutations?** and **Where does Proxy help and where does it stop?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
