...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_083_capstone_build_ii_auth_proxy_mutations_tests_and_portfolio_proof.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **How do we connect identity to protected mutations?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Where does Proxy help and where does it stop?**.
...
7. The comparison table distinguishes **How do we connect identity to protected mutations?** from **Where does Proxy help and where does it stop?** by responsibility, lifetime, and direction of data flow.
