...
Use these after attempting the [exercises](exercises.md). They are specific to **Next.js installation and project structure** and should unblock the next thought without replacing it.
