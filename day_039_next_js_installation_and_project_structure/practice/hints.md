...
Use these only after attempting the numbered exercises in [the lesson](../day_039_next_js_installation_and_project_structure.md). They are specific to **Next.js installation and project structure** and should unblock the next thought without replacing it.
