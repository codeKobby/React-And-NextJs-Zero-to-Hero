# Day 039 hints: Next.js installation and project structure

These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_039_next_js_installation_and_project_structure.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What does create-next-app configure?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What does create-next-app configure?** and **What belongs at the root?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
