...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_039_next_js_installation_and_project_structure.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What does create-next-app configure?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What belongs at the root?**.
...
7. The comparison table distinguishes **What does create-next-app configure?** from **What belongs at the root?** by responsibility, lifetime, and direction of data flow.
