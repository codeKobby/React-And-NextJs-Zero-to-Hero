...
Use this guide after attempting [the exercises](exercises.md). It reviews the decisions for **Route Handlers, API contracts, and typed errors**; it is not a copied answer key.
