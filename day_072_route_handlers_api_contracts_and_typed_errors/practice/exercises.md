...
Use this worksheet after reading [the lesson](../day_072_route_handlers_api_contracts_and_typed_errors.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Route Handlers, API contracts, and typed errors** and uses only local, synthetic, bounded data.
