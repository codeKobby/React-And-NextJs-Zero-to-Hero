...
| --- | --- |
| `context` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `provider` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `consumer` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `default value` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `global state` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What problem does Context solve?

Start with the ordinary-language question: **What problem does Context solve?**. In **Context and providers**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **When is Context appropriate?**. In **Context and providers**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Where should a provider be placed?

Start with the ordinary-language question: **Where should a provider be placed?**. In **Context and providers**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Why is Context not a replacement for every state tool?

Start with the ordinary-language question: **Why is Context not a replacement for every state tool?**. In **Context and providers**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
