...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_020_context_and_providers.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What problem does Context solve?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **When is Context appropriate?**.
...
7. The comparison table distinguishes **What problem does Context solve?** from **When is Context appropriate?** by responsibility, lifetime, and direction of data flow.
