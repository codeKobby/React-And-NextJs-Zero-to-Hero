...
Use this guide only after attempting the numbered exercises in [the lesson](../day_020_context_and_providers.md). It reviews the decisions for **Context and providers**; it is not a copied answer key.
