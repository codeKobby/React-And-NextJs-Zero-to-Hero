...
1. Read the short problem statement for context and providers and say what the page or program should do.
...
4. Change one input for What problem does Context solve?. Keep every other line the same.
5. For When is Context appropriate?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try Where should a provider be placed?.
