...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_020_context_and_providers.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What problem does Context solve?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What problem does Context solve?** and **When is Context appropriate?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
