...
Use this worksheet after reading [the lesson](../day_020_context_and_providers.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Context and providers** and uses only local, synthetic, bounded data.
