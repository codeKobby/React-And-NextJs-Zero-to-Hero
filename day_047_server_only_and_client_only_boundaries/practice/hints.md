...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_047_server_only_and_client_only_boundaries.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **Why should secrets stay server-side?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **Why should secrets stay server-side?** and **What is environment poisoning?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
