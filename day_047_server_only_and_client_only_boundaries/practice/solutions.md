...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_047_server_only_and_client_only_boundaries.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **Why should secrets stay server-side?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What is environment poisoning?**.
...
7. The comparison table distinguishes **Why should secrets stay server-side?** from **What is environment poisoning?** by responsibility, lifetime, and direction of data flow.
