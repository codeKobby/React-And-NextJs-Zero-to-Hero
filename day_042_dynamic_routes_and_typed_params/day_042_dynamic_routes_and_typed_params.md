...
| --- | --- |
| `dynamic segment` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `params` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `slug` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `catch-all` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `searchParams` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a dynamic segment?

Start with the ordinary-language question: **What is a dynamic segment?**. In **Dynamic routes and typed params**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **How do params arrive?**. In **Dynamic routes and typed params**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### When do we use searchParams?

Start with the ordinary-language question: **When do we use searchParams?**. In **Dynamic routes and typed params**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What does catch-all mean?

Start with the ordinary-language question: **What does catch-all mean?**. In **Dynamic routes and typed params**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
