...
Use this worksheet after reading [the lesson](../day_042_dynamic_routes_and_typed_params.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Dynamic routes and typed params** and uses only local, synthetic, bounded data.
