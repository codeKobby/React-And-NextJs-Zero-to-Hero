...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_041_layouts_pages_and_route_segments.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What makes a route public?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What makes a route public?** and **What does a layout preserve?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
