...
Use this worksheet after reading [the lesson](../day_041_layouts_pages_and_route_segments.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Layouts, pages, and route segments** and uses only local, synthetic, bounded data.
