...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_041_layouts_pages_and_route_segments.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What makes a route public?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What does a layout preserve?**.
...
7. The comparison table distinguishes **What makes a route public?** from **What does a layout preserve?** by responsibility, lifetime, and direction of data flow.
