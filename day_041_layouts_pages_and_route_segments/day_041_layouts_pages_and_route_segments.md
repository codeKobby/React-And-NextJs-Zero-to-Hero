...
| --- | --- |
| `page` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `layout` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `children` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `segment` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `nested layout` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `Link` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What makes a route public?

Start with the ordinary-language question: **What makes a route public?**. In **Layouts, pages, and route segments**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **What does a layout preserve?**. In **Layouts, pages, and route segments**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do folders map to URLs?

Start with the ordinary-language question: **How do folders map to URLs?**. In **Layouts, pages, and route segments**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How does Link navigate?

Start with the ordinary-language question: **How does Link navigate?**. In **Layouts, pages, and route segments**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
