# Day 041: Layouts, pages, and route segments

[← Previous lesson](../day_040_root_app_versus_src_app/day_040_root_app_versus_src_app.md) · [Start here](../README.md) · [Setup](../SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_042_dynamic_routes_and_typed_params/day_042_dynamic_routes_and_typed_params.md)
...
- [Topics](#topics)
  - [What makes a route public?](#what-makes-a-route-public)
  - [What does a layout preserve?](#what-does-a-layout-preserve)
  - [How do folders map to URLs?](#how-do-folders-map-to-urls)
  - [How does Link navigate?](#how-does-link-navigate)
...
By the end, you should be able to explain the main idea in your own words, show the normal and broken behavior, trace the important values, predict a boundary result, and apply **layouts, pages, and route segments** to a small local fixture that demonstrates layouts, pages, and route segments. You should be able to name the owner and boundary—the code or framework boundary that owns the decision in this lesson—and state what the example does not prove about production readiness, security, accessibility, performance, or correctness.
...
```text
The files define / and /dashboard.
```
...
| ---: | --- |
| 1 | `app/layout.tsx` — Runs inside the current example; connect its effect to the code or framework boundary that owns the decision in this lesson. |
| 2 | `app/page.tsx` — Runs inside the current example; connect its effect to the code or framework boundary that owns the decision in this lesson. |
| 3 | `app/dashboard/page.tsx` — Runs inside the current example; connect its effect to the code or framework boundary that owns the decision in this lesson. |

Use the table as a starting point, not as a substitute for running the code. Add a note beside any line whose behavior differs between a browser, React, and Next.js server environment.

## Execution trace

1. Start with the fixture's initial input: Learners need a concrete reason to study layouts, pages, and route segments before the terminology becomes useful.
...
Before running the experiment, write your prediction. Change exactly one input or boundary related to **Layouts, pages, and route segments**. Use a normal alternative first, then a boundary such as an empty value, invalid value, loading condition, missing route parameter, rejected action, unauthorized actor, or reordered record when it fits the lesson. Predict the visible output or error, run it, and explain the difference. Restore the original case to prove the repair preserved the normal behavior.

## Broken example and repair

A deliberate failure is part of the lesson. **Broken version:** Add a folder without page.tsx and explain why it is not public.
...
10. Apply the lesson to a small local fixture that demonstrates layouts, pages, and route segments and document the route map.
...
You are finished when you can teach **Layouts, pages, and route segments** to another beginner, show the normal and broken runs, explain the repair, and point to **the code or framework boundary that owns the decision in this lesson**. You should be able to name one limitation and one piece of evidence that would be required before making a production claim. Do not move on because the code merely compiles.
