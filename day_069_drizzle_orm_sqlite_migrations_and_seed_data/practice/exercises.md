...
Use this worksheet after reading [the lesson](../day_069_drizzle_orm_sqlite_migrations_and_seed_data.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Drizzle ORM, SQLite, migrations, and seed data** and uses only local, synthetic, bounded data.
