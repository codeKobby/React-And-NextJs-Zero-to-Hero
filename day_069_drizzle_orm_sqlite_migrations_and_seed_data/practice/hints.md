...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_069_drizzle_orm_sqlite_migrations_and_seed_data.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What does an ORM do?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What does an ORM do?** and **Why are migrations committed?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
