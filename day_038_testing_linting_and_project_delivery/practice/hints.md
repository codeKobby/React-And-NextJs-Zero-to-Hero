...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_038_testing_linting_and_project_delivery.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What does each check prove?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What does each check prove?** and **Why are lint and type checks different?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
