...
| --- | --- |
| `lint` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `typecheck` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `test` | A term you will use in this lesson; test it in the examples before memorizing it. |
...
| `regression` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `review` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What does each check prove?

Start with the ordinary-language question: **What does each check prove?**. In **Testing, linting, and project delivery**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why are lint and type checks different?**. In **Testing, linting, and project delivery**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **How do we review a change?**. In **Testing, linting, and project delivery**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
