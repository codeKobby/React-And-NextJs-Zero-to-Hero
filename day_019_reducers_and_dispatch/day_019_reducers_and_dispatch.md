...
| --- | --- |
| `reducer` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `action` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `dispatch` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `pure function` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `state transition` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a reducer?

Start with the ordinary-language question: **What is a reducer?**. In **Reducers and dispatch**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why name state transitions as actions?**. In **Reducers and dispatch**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What makes a reducer pure?

Start with the ordinary-language question: **What makes a reducer pure?**. In **Reducers and dispatch**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### When is useReducer clearer than useState?

Start with the ordinary-language question: **When is useReducer clearer than useState?**. In **Reducers and dispatch**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
