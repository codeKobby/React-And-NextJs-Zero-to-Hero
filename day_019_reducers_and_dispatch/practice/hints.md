...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_019_reducers_and_dispatch.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is a reducer?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is a reducer?** and **Why name state transitions as actions?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
