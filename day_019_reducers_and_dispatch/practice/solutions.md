...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_019_reducers_and_dispatch.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is a reducer?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why name state transitions as actions?**.
...
7. The comparison table distinguishes **What is a reducer?** from **Why name state transitions as actions?** by responsibility, lifetime, and direction of data flow.
