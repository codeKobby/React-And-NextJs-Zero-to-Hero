...
Use this worksheet after reading [the lesson](../day_019_reducers_and_dispatch.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Reducers and dispatch** and uses only local, synthetic, bounded data.
