...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_080_production_configuration_ci_and_deployment_evidence.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What belongs in an environment variable?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What should CI prove?**.
...
7. The comparison table distinguishes **What belongs in an environment variable?** from **What should CI prove?** by responsibility, lifetime, and direction of data flow.
