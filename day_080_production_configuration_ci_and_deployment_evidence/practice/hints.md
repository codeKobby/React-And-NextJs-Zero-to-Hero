...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_080_production_configuration_ci_and_deployment_evidence.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What belongs in an environment variable?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What belongs in an environment variable?** and **What should CI prove?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
