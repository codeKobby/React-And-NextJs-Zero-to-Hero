...
To answer **How do migrations run safely**, follow the operation in order and check the example. For **How do migrations run safely**, write the starting value, the change you made, and the new result.
...
5. Use an empty list, empty string, or missing value that fits **How do migrations run safely?**. Say what should happen.
