...
1. Read the short problem statement for accessibility and resilient ui and say what the page or program should do.
...
4. Change one input for How does a full-stack app remain accessible?. Keep every other line the same.
5. For Where do focus and errors live?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try How do loading states help?.
