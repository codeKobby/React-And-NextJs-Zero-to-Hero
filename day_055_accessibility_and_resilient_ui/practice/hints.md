...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_055_accessibility_and_resilient_ui.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How does a full-stack app remain accessible?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How does a full-stack app remain accessible?** and **Where do focus and errors live?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
