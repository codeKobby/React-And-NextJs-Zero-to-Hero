...
Use this worksheet after reading [the lesson](../day_061_getters_setters_and_state_boundaries.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Getters, setters, and state boundaries** and uses only local, synthetic, bounded data.
...
10. Apply the lesson to a controlled case draft whose fields update without erasing each other using synthetic data.
11. Explain why the state belongs at the the render snapshot, pending update queue, and component that owns the setter.
