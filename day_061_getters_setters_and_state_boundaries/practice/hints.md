...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_061_getters_setters_and_state_boundaries.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is a getter?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is a getter?** and **What is a setter?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
