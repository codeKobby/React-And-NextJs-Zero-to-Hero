...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_056_performance_and_bundle_boundaries.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What JavaScript reaches the browser?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why keep client boundaries narrow?**.
...
7. The comparison table distinguishes **What JavaScript reaches the browser?** from **Why keep client boundaries narrow?** by responsibility, lifetime, and direction of data flow.
