...
1. Read the short problem statement for performance and bundle boundaries and say what the page or program should do.
...
4. Change one input for What JavaScript reaches the browser?. Keep every other line the same.
5. For Why keep client boundaries narrow?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try When should we lazy-load?.
