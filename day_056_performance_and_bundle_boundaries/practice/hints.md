...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_056_performance_and_bundle_boundaries.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What JavaScript reaches the browser?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What JavaScript reaches the browser?** and **Why keep client boundaries narrow?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
