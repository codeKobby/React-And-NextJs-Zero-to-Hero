...
| --- | --- |
| `bundle` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `hydration` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `client boundary` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `dynamic import` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `image` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `cache` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What JavaScript reaches the browser?

Start with the ordinary-language question: **What JavaScript reaches the browser?**. In **Performance and bundle boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why keep client boundaries narrow?**. In **Performance and bundle boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### When should we lazy-load?

Start with the ordinary-language question: **When should we lazy-load?**. In **Performance and bundle boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do images and fonts affect performance?

Start with the ordinary-language question: **How do images and fonts affect performance?**. In **Performance and bundle boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
