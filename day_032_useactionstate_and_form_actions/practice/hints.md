...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_032_useactionstate_and_form_actions.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What does useActionState return?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What does useActionState return?** and **How does a form action receive FormData?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
