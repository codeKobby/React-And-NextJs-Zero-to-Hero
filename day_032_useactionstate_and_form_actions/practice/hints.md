...
1. Read the short problem statement for useactionstate and form actions and say what the page or program should do.
...
4. Change one input for What does useActionState return?. Keep every other line the same.
5. For How does a form action receive FormData?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try Where should validation happen?.
