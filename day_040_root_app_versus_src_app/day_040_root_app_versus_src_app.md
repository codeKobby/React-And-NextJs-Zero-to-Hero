...
| `app` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `pages` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `precedence` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `configuration` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `alias` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### Why use src?

Start with the ordinary-language question: **Why use src?**. In **Root app versus src/app**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **When is root-level app simpler?**. In **Root app versus src/app**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Which files stay at root?

Start with the ordinary-language question: **Which files stay at root?**. In **Root app versus src/app**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Why must we not keep duplicate routers?

Start with the ordinary-language question: **Why must we not keep duplicate routers?**. In **Root app versus src/app**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
