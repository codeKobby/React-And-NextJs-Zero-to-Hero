...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_040_root_app_versus_src_app.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **Why use src?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **Why use src?** and **When is root-level app simpler?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
