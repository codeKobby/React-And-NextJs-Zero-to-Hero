...
Use these after attempting the [exercises](exercises.md). They are specific to **Route Handlers and HTTP APIs** and should unblock the next thought without replacing it.
