...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_052_route_handlers_and_http_apis.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is a Route Handler?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is a Route Handler?** and **When do we need an HTTP endpoint?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
