...
| --- | --- |
| `route.ts` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `GET` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `POST` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `Request` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `Response` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `status` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `headers` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a Route Handler?

Start with the ordinary-language question: **What is a Route Handler?**. In **Route Handlers and HTTP APIs**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **When do we need an HTTP endpoint?**. In **Route Handlers and HTTP APIs**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we validate a request?

Start with the ordinary-language question: **How do we validate a request?**. In **Route Handlers and HTTP APIs**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How should status and errors be shaped?

Start with the ordinary-language question: **How should status and errors be shaped?**. In **Route Handlers and HTTP APIs**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
