...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_075_next_js_16_proxy_and_the_middleware_migration.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What changed from middleware.ts to proxy.ts?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What changed from middleware.ts to proxy.ts?** and **What does Proxy run before?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
