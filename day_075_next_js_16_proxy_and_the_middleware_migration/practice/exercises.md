...
Use this worksheet after reading [the lesson](../day_075_next_js_16_proxy_and_the_middleware_migration.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Next.js 16 Proxy and the middleware migration** and uses only local, synthetic, bounded data.
