...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_016_controlled_forms.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What makes an input controlled?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **How do value and setter work together?**.
...
7. The comparison table distinguishes **What makes an input controlled?** from **How do value and setter work together?** by responsibility, lifetime, and direction of data flow.
