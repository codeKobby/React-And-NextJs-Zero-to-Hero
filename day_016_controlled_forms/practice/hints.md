...
1. Read the short problem statement for controlled forms and say what the page or program should do.
...
4. Change one input for What makes an input controlled?. Keep every other line the same.
5. For How do value and setter work together?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try When should validation run?.
