...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_016_controlled_forms.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What makes an input controlled?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What makes an input controlled?** and **How do value and setter work together?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
