...
Use this worksheet after reading [the lesson](../day_016_controlled_forms.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Controlled forms** and uses only local, synthetic, bounded data.
...
1. Define **What makes an input controlled?** in your own words and point to its first concrete example.
...
4. Change one input while preserving the rule for **How do value and setter work together?**, then predict before running.
5. Create a boundary case involving **When should validation run?** and choose deliberate behavior.
6. Reproduce the deliberate failure: Provide value without onChange, observe the locked input, and repair the pair.
...
10. Apply controlled forms to a small local fixture that demonstrates controlled forms with a local synthetic fixture.
