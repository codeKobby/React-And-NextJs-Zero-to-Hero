...
| --- | --- |
| `dependency array` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `stale closure` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `cleanup` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `subscription` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `abort` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a stale closure?

Start with the ordinary-language question: **What is a stale closure?**. In **Effect dependencies and cleanup**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why must dependencies be complete?**. In **Effect dependencies and cleanup**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we clean up a subscription?

Start with the ordinary-language question: **How do we clean up a subscription?**. In **Effect dependencies and cleanup**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we abort a request?

Start with the ordinary-language question: **How do we abort a request?**. In **Effect dependencies and cleanup**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
