...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_022_effect_dependencies_and_cleanup.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is a stale closure?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is a stale closure?** and **Why must dependencies be complete?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
