...
Use this worksheet after reading [the lesson](../day_033_useformstatus_and_useoptimistic.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **useFormStatus and useOptimistic** and uses only local, synthetic, bounded data.
