...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_033_useformstatus_and_useoptimistic.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How can a child button know a form is pending?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How can a child button know a form is pending?** and **What is an optimistic update?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
