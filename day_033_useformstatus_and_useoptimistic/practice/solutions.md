...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_033_useformstatus_and_useoptimistic.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **How can a child button know a form is pending?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What is an optimistic update?**.
...
7. The comparison table distinguishes **How can a child button know a form is pending?** from **What is an optimistic update?** by responsibility, lifetime, and direction of data flow.
