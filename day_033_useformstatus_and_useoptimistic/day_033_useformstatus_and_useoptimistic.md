...
| --- | --- |
| `useFormStatus` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `pending` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `optimistic update` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `rollback` | A term you will use in this lesson; test it in the examples before memorizing it. |
...
Start with the ordinary-language question: **What is an optimistic update?**. In **useFormStatus and useOptimistic**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### When must optimistic UI roll back?

Start with the ordinary-language question: **When must optimistic UI roll back?**. In **useFormStatus and useOptimistic**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we communicate uncertainty?

Start with the ordinary-language question: **How do we communicate uncertainty?**. In **useFormStatus and useOptimistic**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
