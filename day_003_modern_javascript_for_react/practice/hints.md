...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_003_modern_javascript_for_react.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **Which JavaScript expressions appear in JSX?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **Which JavaScript expressions appear in JSX?** and **Why does map return a new array?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
