...
Use this worksheet after reading [the lesson](../day_003_modern_javascript_for_react.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Modern JavaScript for React** and uses only local, synthetic, bounded data.
