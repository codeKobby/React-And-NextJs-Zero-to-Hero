...
| `startTransition` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `useTransition` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `deferred value` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `priority` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is an urgent update?

Start with the ordinary-language question: **What is an urgent update?**. In **Transitions and responsive updates**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **What is a transition?**. In **Transitions and responsive updates**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How does useTransition expose pending state?

Start with the ordinary-language question: **How does useTransition expose pending state?**. In **Transitions and responsive updates**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### When is useDeferredValue useful?

Start with the ordinary-language question: **When is useDeferredValue useful?**. In **Transitions and responsive updates**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
