...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_025_transitions_and_responsive_updates.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is an urgent update?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is an urgent update?** and **What is a transition?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
