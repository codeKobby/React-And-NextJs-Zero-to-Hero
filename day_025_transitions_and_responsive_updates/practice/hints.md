...
1. Read the short problem statement for transitions and responsive updates and say what the page or program should do.
...
4. Change one input for What is an urgent update?. Keep every other line the same.
5. For What is a transition?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try How does useTransition expose pending state?.
