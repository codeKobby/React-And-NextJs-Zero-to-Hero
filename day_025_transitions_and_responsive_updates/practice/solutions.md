...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_025_transitions_and_responsive_updates.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is an urgent update?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What is a transition?**.
...
7. The comparison table distinguishes **What is an urgent update?** from **What is a transition?** by responsibility, lifetime, and direction of data flow.
