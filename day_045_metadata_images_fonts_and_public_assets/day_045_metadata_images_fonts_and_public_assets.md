...
| `generateMetadata` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `Image` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `font` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `public` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `alt text` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### Where does page metadata live?

Start with the ordinary-language question: **Where does page metadata live?**. In **Metadata, images, fonts, and public assets**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why use next/image?**. In **Metadata, images, fonts, and public assets**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What belongs in public?

Start with the ordinary-language question: **What belongs in public?**. In **Metadata, images, fonts, and public assets**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do alt text and font loading affect quality?

Start with the ordinary-language question: **How do alt text and font loading affect quality?**. In **Metadata, images, fonts, and public assets**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
