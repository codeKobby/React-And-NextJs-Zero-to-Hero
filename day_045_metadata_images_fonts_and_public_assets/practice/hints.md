...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_045_metadata_images_fonts_and_public_assets.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **Where does page metadata live?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **Where does page metadata live?** and **Why use next/image?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
