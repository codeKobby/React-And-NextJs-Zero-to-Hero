...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_045_metadata_images_fonts_and_public_assets.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **Where does page metadata live?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why use next/image?**.
...
7. The comparison table distinguishes **Where does page metadata live?** from **Why use next/image?** by responsibility, lifetime, and direction of data flow.
