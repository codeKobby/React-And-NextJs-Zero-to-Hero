# Day 012 solution guide: What is state?

Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_012_what_is_state.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is state?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why is state different from an ordinary variable?**.
...
7. The comparison table distinguishes **What is state?** from **Why is state different from an ordinary variable?** by responsibility, lifetime, and direction of data flow.
