...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_012_what_is_state.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is state?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is state?** and **Why is state different from an ordinary variable?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
