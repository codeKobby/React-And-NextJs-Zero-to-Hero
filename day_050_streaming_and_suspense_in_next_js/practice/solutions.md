...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_050_streaming_and_suspense_in_next_js.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is streaming?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why do waterfalls happen?**.
...
7. The comparison table distinguishes **What is streaming?** from **Why do waterfalls happen?** by responsibility, lifetime, and direction of data flow.
