...
Use these only after attempting the numbered exercises in [the lesson](../day_050_streaming_and_suspense_in_next_js.md). They are specific to **Streaming and Suspense in Next.js** and should unblock the next thought without replacing it.

## Hints

1. Read the short problem statement for streaming and suspense in next.js and say what the page or program should do.
...
4. Change one input for What is streaming?. Keep every other line the same.
5. For Why do waterfalls happen?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try Where should Suspense boundaries live?.
