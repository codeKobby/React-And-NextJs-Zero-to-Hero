...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_050_streaming_and_suspense_in_next_js.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is streaming?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is streaming?** and **Why do waterfalls happen?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
