...
Use these after attempting the [exercises](exercises.md). They are specific to **Secure sessions and cookie policy** and should unblock the next thought without replacing it.
