...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_074_secure_sessions_and_cookie_policy.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is session management?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is session management?** and **Why must session code be server-only?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
