...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_028_class_lifecycle_to_modern_hooks.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What did lifecycle methods do?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What did lifecycle methods do?** and **How does one Effect model synchronization?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
