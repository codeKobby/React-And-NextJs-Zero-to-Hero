...
Use this worksheet after reading [the lesson](../day_028_class_lifecycle_to_modern_hooks.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Class lifecycle to modern Hooks** and uses only local, synthetic, bounded data.
