...
Use these after attempting the [exercises](exercises.md). They are specific to **SQL and relational data modeling** and should unblock the next thought without replacing it.
