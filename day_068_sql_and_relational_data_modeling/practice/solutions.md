...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_068_sql_and_relational_data_modeling.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is a table?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why do rows need stable identifiers?**.
...
7. The comparison table distinguishes **What is a table?** from **Why do rows need stable identifiers?** by responsibility, lifetime, and direction of data flow.
