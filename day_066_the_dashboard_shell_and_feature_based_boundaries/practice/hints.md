...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_066_the_dashboard_shell_and_feature_based_boundaries.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What makes a dashboard shell?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What makes a dashboard shell?** and **How do route groups organize features?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
