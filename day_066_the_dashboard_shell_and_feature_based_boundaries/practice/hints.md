...
1. Read the short problem statement for the dashboard shell and feature-based boundaries and say what the page or program should do.
...
4. Change one input for What makes a dashboard shell?. Keep every other line the same.
5. For How do route groups organize features?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try Where should navigation state live?.
