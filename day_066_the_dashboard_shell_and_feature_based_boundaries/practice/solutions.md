...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_066_the_dashboard_shell_and_feature_based_boundaries.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What makes a dashboard shell?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **How do route groups organize features?**.
...
7. The comparison table distinguishes **What makes a dashboard shell?** from **How do route groups organize features?** by responsibility, lifetime, and direction of data flow.
