...
Use this worksheet after reading [the lesson](../day_070_repositories_and_server_only_data_access.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Repositories and server-only data access** and uses only local, synthetic, bounded data.
