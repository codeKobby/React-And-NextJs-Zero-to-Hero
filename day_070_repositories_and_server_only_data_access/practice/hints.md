...
1. Read the short problem statement for repositories and server-only data access and say what the page or program should do.
...
4. Change one input for Why isolate database calls?. Keep every other line the same.
5. For What is a repository?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try What data should cross into a Client Component?.
