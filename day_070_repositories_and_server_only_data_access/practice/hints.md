...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_070_repositories_and_server_only_data_access.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **Why isolate database calls?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **Why isolate database calls?** and **What is a repository?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
