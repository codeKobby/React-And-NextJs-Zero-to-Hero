...
| --- | --- |
| `DOM` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `element` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `attribute` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `semantic HTML` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `accessibility` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `event` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is the DOM?

Start with the ordinary-language question: **What is the DOM?**. In **HTML, CSS, accessibility, and the DOM**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why does semantic HTML matter?**. In **HTML, CSS, accessibility, and the DOM**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How does a browser event reach code?

Start with the ordinary-language question: **How does a browser event reach code?**. In **HTML, CSS, accessibility, and the DOM**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What does React improve and what does it not replace?

Start with the ordinary-language question: **What does React improve and what does it not replace?**. In **HTML, CSS, accessibility, and the DOM**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
