...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_002_html_css_accessibility_and_the_dom.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is the DOM?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is the DOM?** and **Why does semantic HTML matter?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
