# Day 002 solution guide: HTML, CSS, accessibility, and the DOM

Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_002_html_css_accessibility_and_the_dom.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is the DOM?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why does semantic HTML matter?**.
...
7. The comparison table distinguishes **What is the DOM?** from **Why does semantic HTML matter?** by responsibility, lifetime, and direction of data flow.
