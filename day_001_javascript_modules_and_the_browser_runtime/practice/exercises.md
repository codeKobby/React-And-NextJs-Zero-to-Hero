...
Use this worksheet after reading [the lesson](../day_001_javascript_modules_and_the_browser_runtime.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **JavaScript modules and the browser runtime** and uses only local, synthetic, bounded data.
