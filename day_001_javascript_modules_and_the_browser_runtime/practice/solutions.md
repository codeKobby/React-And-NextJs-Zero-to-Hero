...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_001_javascript_modules_and_the_browser_runtime.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is a JavaScript runtime?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What is a module?**.
...
7. The comparison table distinguishes **What is a JavaScript runtime?** from **What is a module?** by responsibility, lifetime, and direction of data flow.
