...
To answer **How do we inspect a small program**, follow the operation in order rather than treating the result as framework magic. For **How do we inspect a small program**, write the starting value, the change you made, and the new result.
...
5. Add one simple edge case for **Why does the browser environment differ from Node.js?**, such as an empty or invalid value.
