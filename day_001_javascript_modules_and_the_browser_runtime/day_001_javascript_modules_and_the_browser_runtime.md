...
| --- | --- |
| `JavaScript modules` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `browser` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `Node.js` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `strict mode` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `import` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `export` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a JavaScript runtime?

Start with the ordinary-language question: **What is a JavaScript runtime?**. In **JavaScript modules and the browser runtime**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **What is a module?**. In **JavaScript modules and the browser runtime**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Why does the browser environment differ from Node.js?

Start with the ordinary-language question: **Why does the browser environment differ from Node.js?**. In **JavaScript modules and the browser runtime**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we inspect a small program?

Start with the ordinary-language question: **How do we inspect a small program?**. In **JavaScript modules and the browser runtime**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
