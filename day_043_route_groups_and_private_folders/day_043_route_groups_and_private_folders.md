...
Here is the problem: The learner needs to see what route groups and private folders does before learning its name.

A small workshop task lets the learner change one thing and see the result.

Today we will learn **Route groups and private folders** in small steps. We will run a small example, change one input, look at the result, make a common mistake, fix it, and try one small variation. You are learning what the code does, not just memorising a word.
...
- explain **Route groups and private folders** in your own words;
- run the normal example;
- show the broken example and fix it;
- change one input and predict the result; and
- use **route groups and private folders** in a small local example.
...
Start with the learner's concrete question: **What is a route group**. Look at **What is a route group** in the example before learning the technical name. For **What is a route group**, point to the smallest value, element, function, or route that shows the answer.

**Try it before moving on:** For **What is a route group**, say what goes in and what comes out.

### Why does parentheses not change the URL?

Answer **Why does parentheses not change the URL** by comparing the working example with a broken or limited example. For **Why does parentheses not change the URL**, say what changed and which result is easier or safer to use.

**Try it before moving on:** For **Why does parentheses not change the URL?**, compare the working example with the broken example. What changed? Which result is safer or easier to understand?

### What is a private folder?

Start with the learner's concrete question: **What is a private folder**. Look at **What is a private folder** in the example before learning the technical name. For **What is a private folder**, point to the smallest value, element, function, or route that shows the answer.

**Try it before moving on:** For **What is a private folder**, say what goes in and what comes out.

### What can be colocated safely?

Start with the learner's concrete question: **What can be colocated safely**. Look at **What can be colocated safely** in the example before learning the technical name. For **What can be colocated safely**, point to the smallest value, element, function, or route that shows the answer.

**Try it before moving on:** For **What can be colocated safely**, say what goes in and what comes out.
...
| ---: | --- |
| 1 | `app/(marketing)/about/page.tsx` — Runs as part of this example. After `app/(marketing)/about/page.tsx`, check the next line to see the result. |
| 2 | `app/dashboard/_components/Nav.tsx` — Runs as part of this example. After `app/dashboard/_components/Nav.tsx`, check the next line to see the result. |
...
1. Write down the starting value: The learner needs to see what route groups and private folders does before learning its name.
...
4. Use the same starter for **route groups and private folders** and a small local example.
...
1. explain **Route groups and private folders** to another beginner;
