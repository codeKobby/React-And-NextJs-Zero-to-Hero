...
| --- | --- |
| `route group` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `private folder` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `colocation` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `URL` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `layout scope` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a route group?

Start with the ordinary-language question: **What is a route group?**. In **Route groups and private folders**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why does parentheses not change the URL?**. In **Route groups and private folders**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What is a private folder?

Start with the ordinary-language question: **What is a private folder?**. In **Route groups and private folders**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What can be colocated safely?

Start with the ordinary-language question: **What can be colocated safely?**. In **Route groups and private folders**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
