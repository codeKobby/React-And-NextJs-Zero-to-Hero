...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_043_route_groups_and_private_folders.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is a route group?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why does parentheses not change the URL?**.
...
7. The comparison table distinguishes **What is a route group?** from **Why does parentheses not change the URL?** by responsibility, lifetime, and direction of data flow.
