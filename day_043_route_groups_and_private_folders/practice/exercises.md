...
Use this worksheet after reading [the lesson](../day_043_route_groups_and_private_folders.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Route groups and private folders** and uses only local, synthetic, bounded data.
