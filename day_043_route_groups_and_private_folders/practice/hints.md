...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_043_route_groups_and_private_folders.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is a route group?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is a route group?** and **Why does parentheses not change the URL?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
