...
To answer **How do we measure before optimizing**, follow the operation in order rather than treating the result as framework magic. For **How do we measure before optimizing**, write the starting value, the change you made, and the new result.
...
5. Add one simple edge case for **What creates unnecessary renders?**, such as an empty or invalid value.
