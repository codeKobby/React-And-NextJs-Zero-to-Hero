...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_036_react_performance_and_profiling.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What does performance mean?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **How do we measure before optimizing?**.
...
7. The comparison table distinguishes **What does performance mean?** from **How do we measure before optimizing?** by responsibility, lifetime, and direction of data flow.
