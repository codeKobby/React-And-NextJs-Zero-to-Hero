...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_036_react_performance_and_profiling.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What does performance mean?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What does performance mean?** and **How do we measure before optimizing?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
