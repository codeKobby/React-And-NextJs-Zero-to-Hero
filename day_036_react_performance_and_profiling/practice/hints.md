...
1. Read the short problem statement for react performance and profiling and say what the page or program should do.
...
4. Change one input for What does performance mean?. Keep every other line the same.
5. For How do we measure before optimizing?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try What creates unnecessary renders?.
