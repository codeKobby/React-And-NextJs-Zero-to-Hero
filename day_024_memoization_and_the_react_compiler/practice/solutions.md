...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_024_memoization_and_the_react_compiler.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is memoization?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **When can memoization help?**.
...
7. The comparison table distinguishes **What is memoization?** from **When can memoization help?** by responsibility, lifetime, and direction of data flow.
