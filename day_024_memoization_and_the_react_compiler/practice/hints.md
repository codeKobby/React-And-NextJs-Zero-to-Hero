...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_024_memoization_and_the_react_compiler.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is memoization?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is memoization?** and **When can memoization help?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
