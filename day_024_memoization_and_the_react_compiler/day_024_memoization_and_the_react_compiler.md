...
| --- | --- |
| `memoization` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `memo` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `useMemo` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `useCallback` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `compiler` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `purity` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is memoization?

Start with the ordinary-language question: **What is memoization?**. In **Memoization and the React Compiler**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **When can memoization help?**. In **Memoization and the React Compiler**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Why can premature memoization hurt clarity?

Start with the ordinary-language question: **Why can premature memoization hurt clarity?**. In **Memoization and the React Compiler**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How does the React Compiler change the decision?

Start with the ordinary-language question: **How does the React Compiler change the decision?**. In **Memoization and the React Compiler**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
