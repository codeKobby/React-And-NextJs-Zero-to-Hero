...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_081_capstone_architecture_threat_model_and_delivery_plan.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **How do we plan a full app?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What is a threat model?**.
...
7. The comparison table distinguishes **How do we plan a full app?** from **What is a threat model?** by responsibility, lifetime, and direction of data flow.
