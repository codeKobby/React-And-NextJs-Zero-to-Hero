...
Use this worksheet after reading [the lesson](../day_081_capstone_architecture_threat_model_and_delivery_plan.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Capstone architecture, threat model, and delivery plan** and uses only local, synthetic, bounded data.
