...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_081_capstone_architecture_threat_model_and_delivery_plan.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How do we plan a full app?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How do we plan a full app?** and **What is a threat model?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
