...
| --- | --- |
| `condition` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `ternary` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `logical AND` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `null` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `empty state` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### How does React choose what to render?

Start with the ordinary-language question: **How does React choose what to render?**. In **Conditional rendering and empty states**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **When is a ternary clearer than &&?**. In **Conditional rendering and empty states**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What should an empty state say?

Start with the ordinary-language question: **What should an empty state say?**. In **Conditional rendering and empty states**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we avoid rendering zero accidentally?

Start with the ordinary-language question: **How do we avoid rendering zero accidentally?**. In **Conditional rendering and empty states**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
