...
1. Read the short problem statement for conditional rendering and empty states and say what the page or program should do.
...
4. Change one input for How does React choose what to render?. Keep every other line the same.
5. For When is a ternary clearer than &&?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try What should an empty state say?.
