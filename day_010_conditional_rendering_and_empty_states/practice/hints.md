...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_010_conditional_rendering_and_empty_states.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How does React choose what to render?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How does React choose what to render?** and **When is a ternary clearer than &&?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
