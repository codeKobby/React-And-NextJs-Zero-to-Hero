...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_010_conditional_rendering_and_empty_states.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **How does React choose what to render?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **When is a ternary clearer than &&?**.
...
7. The comparison table distinguishes **How does React choose what to render?** from **When is a ternary clearer than &&?** by responsibility, lifetime, and direction of data flow.
