...
Use this worksheet after reading [the lesson](../day_010_conditional_rendering_and_empty_states.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Conditional rendering and empty states** and uses only local, synthetic, bounded data.
...
10. Apply the lesson to a small local fixture that demonstrates conditional rendering and empty states using synthetic data.
