...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_076_authorization_roles_ownership_and_multi_tenant_data.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is authorization?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is authorization?** and **How do roles differ from permissions?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
