...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_011_events_and_event_handlers.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is an event handler?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is an event handler?** and **Why pass a function instead of calling it?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
