...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_049_caching_and_revalidation.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is a cache?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What should be cached?**.
...
7. The comparison table distinguishes **What is a cache?** from **What should be cached?** by responsibility, lifetime, and direction of data flow.
