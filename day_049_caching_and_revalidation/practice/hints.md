...
Use these only after attempting the numbered exercises in [the lesson](../day_049_caching_and_revalidation.md). They are specific to **Caching and revalidation** and should unblock the next thought without replacing it.
