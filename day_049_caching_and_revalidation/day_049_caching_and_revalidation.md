...
| `revalidate` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `tag` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `path` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `invalidation` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `fresh` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `stale` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a cache?

Start with the ordinary-language question: **What is a cache?**. In **Caching and revalidation**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **What should be cached?**. In **Caching and revalidation**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### When should data be revalidated?

Start with the ordinary-language question: **When should data be revalidated?**. In **Caching and revalidation**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do tags and paths invalidate data?

Start with the ordinary-language question: **How do tags and paths invalidate data?**. In **Caching and revalidation**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
