# Day 006 solution guide: What is a component?

Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_006_what_is_a_component.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is a component?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why are function components the modern default?**.
...
7. The comparison table distinguishes **What is a component?** from **Why are function components the modern default?** by responsibility, lifetime, and direction of data flow.
