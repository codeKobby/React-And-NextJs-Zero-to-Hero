...
| --- | --- |
| `component` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `function component` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `props` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `return` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `composition` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a component?

Start with the ordinary-language question: **What is a component?**. In **What is a component?**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why are function components the modern default?**. In **What is a component?**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do components compose?

Start with the ordinary-language question: **How do components compose?**. In **What is a component?**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What makes a component easy to review?

Start with the ordinary-language question: **What makes a component easy to review?**. In **What is a component?**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
