...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_029_error_boundaries_and_failure_ui.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is an error boundary?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is an error boundary?** and **Which errors does it catch?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
