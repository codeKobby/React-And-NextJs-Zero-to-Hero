...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_029_error_boundaries_and_failure_ui.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is an error boundary?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Which errors does it catch?**.
...
7. The comparison table distinguishes **What is an error boundary?** from **Which errors does it catch?** by responsibility, lifetime, and direction of data flow.
