...
Use this worksheet after reading [the lesson](../day_029_error_boundaries_and_failure_ui.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Error boundaries and failure UI** and uses only local, synthetic, bounded data.
