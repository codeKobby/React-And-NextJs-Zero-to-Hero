...
| --- | --- |
| `uncontrolled` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `ref` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `defaultValue` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `DOM node` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `useRef` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is an uncontrolled input?

Start with the ordinary-language question: **What is an uncontrolled input?**. In **Uncontrolled inputs and refs**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **When is a ref useful?**. In **Uncontrolled inputs and refs**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What is the difference between value and defaultValue?

Start with the ordinary-language question: **What is the difference between value and defaultValue?**. In **Uncontrolled inputs and refs**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What should not be stored in refs?

Start with the ordinary-language question: **What should not be stored in refs?**. In **Uncontrolled inputs and refs**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
