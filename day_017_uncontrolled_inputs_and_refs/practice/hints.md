...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_017_uncontrolled_inputs_and_refs.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is an uncontrolled input?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is an uncontrolled input?** and **When is a ref useful?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
