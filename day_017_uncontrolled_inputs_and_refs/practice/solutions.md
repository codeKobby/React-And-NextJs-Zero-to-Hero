...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_017_uncontrolled_inputs_and_refs.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is an uncontrolled input?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **When is a ref useful?**.
...
7. The comparison table distinguishes **What is an uncontrolled input?** from **When is a ref useful?** by responsibility, lifetime, and direction of data flow.
