...
| --- | --- |
| `useState` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `setter` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `functional update` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `initial value` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `batching` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### How does useState return a value and setter?

Start with the ordinary-language question: **How does useState return a value and setter?**. In **useState and setters**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why use a functional updater?**. In **useState and setters**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What does batching mean?

Start with the ordinary-language question: **What does batching mean?**. In **useState and setters**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How should a setter be named?

Start with the ordinary-language question: **How should a setter be named?**. In **useState and setters**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
