# Day 013 solution guide: useState and setters

Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_013_usestate_and_setters.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **How does useState return a value and setter?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why use a functional updater?**.
...
7. The comparison table distinguishes **How does useState return a value and setter?** from **Why use a functional updater?** by responsibility, lifetime, and direction of data flow.
