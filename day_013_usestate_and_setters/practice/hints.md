...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_013_usestate_and_setters.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How does useState return a value and setter?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How does useState return a value and setter?** and **Why use a functional updater?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
