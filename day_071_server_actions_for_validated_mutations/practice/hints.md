...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_071_server_actions_for_validated_mutations.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is a Server Action?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is a Server Action?** and **Where should validation and authorization happen?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
