...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_071_server_actions_for_validated_mutations.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is a Server Action?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Where should validation and authorization happen?**.
...
7. The comparison table distinguishes **What is a Server Action?** from **Where should validation and authorization happen?** by responsibility, lifetime, and direction of data flow.
