...
| --- | --- |
| `metadata` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `title` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `meta` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `ref prop` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `ref cleanup` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `stylesheet` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### How does React render metadata?

Start with the ordinary-language question: **How does React render metadata?**. In **Metadata, refs, and modern React DOM**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **What changed for ref props?**. In **Metadata, refs, and modern React DOM**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What is ref cleanup?

Start with the ordinary-language question: **What is ref cleanup?**. In **Metadata, refs, and modern React DOM**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do DOM resources fit a component?

Start with the ordinary-language question: **How do DOM resources fit a component?**. In **Metadata, refs, and modern React DOM**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
