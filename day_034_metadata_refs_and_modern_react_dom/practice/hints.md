...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_034_metadata_refs_and_modern_react_dom.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **How does React render metadata?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **How does React render metadata?** and **What changed for ref props?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
