...
Use this worksheet after reading [the lesson](../day_034_metadata_refs_and_modern_react_dom.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Metadata, refs, and modern React DOM** and uses only local, synthetic, bounded data.
