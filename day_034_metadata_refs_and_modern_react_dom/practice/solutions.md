...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_034_metadata_refs_and_modern_react_dom.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **How does React render metadata?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What changed for ref props?**.
...
7. The comparison table distinguishes **How does React render metadata?** from **What changed for ref props?** by responsibility, lifetime, and direction of data flow.
