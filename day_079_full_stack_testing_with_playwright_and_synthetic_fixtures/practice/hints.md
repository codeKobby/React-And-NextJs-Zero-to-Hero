...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_079_full_stack_testing_with_playwright_and_synthetic_fixtures.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What should each test level prove?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What should each test level prove?** and **How do we test a protected route?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
