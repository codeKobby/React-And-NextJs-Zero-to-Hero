...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_079_full_stack_testing_with_playwright_and_synthetic_fixtures.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What should each test level prove?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **How do we test a protected route?**.
...
7. The comparison table distinguishes **What should each test level prove?** from **How do we test a protected route?** by responsibility, lifetime, and direction of data flow.
