...
| `parent` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `child` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `read-only` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `callback prop` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `one-way flow` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What are props?

Start with the ordinary-language question: **What are props?**. In **Props and one-way data flow**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why should a child not mutate props?**. In **Props and one-way data flow**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How does data move down?

Start with the ordinary-language question: **How does data move down?**. In **Props and one-way data flow**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How can a child request a parent change?

Start with the ordinary-language question: **How can a child request a parent change?**. In **Props and one-way data flow**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
