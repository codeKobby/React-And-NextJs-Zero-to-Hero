...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_008_props_and_one_way_data_flow.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What are props?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why should a child not mutate props?**.
...
7. The comparison table distinguishes **What are props?** from **Why should a child not mutate props?** by responsibility, lifetime, and direction of data flow.
