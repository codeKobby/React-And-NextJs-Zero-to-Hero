...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_063_responsive_layouts_and_design_tokens_with_tailwind.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is responsive design?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **How do Tailwind breakpoints change a layout?**.
...
7. The comparison table distinguishes **What is responsive design?** from **How do Tailwind breakpoints change a layout?** by responsibility, lifetime, and direction of data flow.
