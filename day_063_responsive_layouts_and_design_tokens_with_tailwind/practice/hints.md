...
Use these after attempting the the numbered exercises in this lesson. They are specific to **Responsive layouts and design tokens with Tailwind** and should unblock the next thought without replacing it.
