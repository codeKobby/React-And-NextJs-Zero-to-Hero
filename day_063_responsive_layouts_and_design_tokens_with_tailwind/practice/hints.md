...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_063_responsive_layouts_and_design_tokens_with_tailwind.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is responsive design?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is responsive design?** and **How do Tailwind breakpoints change a layout?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
