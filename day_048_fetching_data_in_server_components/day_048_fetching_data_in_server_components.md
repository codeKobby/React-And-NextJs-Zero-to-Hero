...
To answer **How do we validate identity and permission**, follow the operation in order rather than treating the result as framework magic. For **How do we validate identity and permission**, write the starting value, the change you made, and the new result.
