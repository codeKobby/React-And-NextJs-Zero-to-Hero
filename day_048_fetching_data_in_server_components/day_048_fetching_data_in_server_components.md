...
| --- | --- |
| `fetch` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `ORM` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `async component` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `request` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `authentication` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `authorization` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### Where should a database query run?

Start with the ordinary-language question: **Where should a database query run?**. In **Fetching data in Server Components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **How do we validate identity and permission?**. In **Fetching data in Server Components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Why can a Server Component access secrets?

Start with the ordinary-language question: **Why can a Server Component access secrets?**. In **Fetching data in Server Components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What does the browser receive?

Start with the ordinary-language question: **What does the browser receive?**. In **Fetching data in Server Components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
