...
Use this worksheet after reading [the lesson](../day_048_fetching_data_in_server_components.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Fetching data in Server Components** and uses only local, synthetic, bounded data.
