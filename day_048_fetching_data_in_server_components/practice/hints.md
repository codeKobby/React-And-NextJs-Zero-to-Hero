...
Use these after attempting the [exercises](exercises.md). They are specific to **Fetching data in Server Components** and should unblock the next thought without replacing it.
