...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_048_fetching_data_in_server_components.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **Where should a database query run?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **Where should a database query run?** and **How do we validate identity and permission?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
