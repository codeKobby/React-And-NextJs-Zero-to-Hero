...
| `assertion` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `user behavior` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `query` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `mock` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `integration` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What should a component test prove?

Start with the ordinary-language question: **What should a component test prove?**. In **Testing components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why test behavior rather than implementation?**. In **Testing components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we test a form?

Start with the ordinary-language question: **How do we test a form?**. In **Testing components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### What should remain real?

Start with the ordinary-language question: **What should remain real?**. In **Testing components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
