...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_014_state_for_objects_and_arrays.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **Why should state updates create new references?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **Why should state updates create new references?** and **How do we update one object field?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
