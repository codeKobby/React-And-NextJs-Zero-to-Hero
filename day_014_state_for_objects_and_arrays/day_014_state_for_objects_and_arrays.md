...
To answer **How do we update one object field**, follow the operation in order rather than treating the result as framework magic. For **How do we update one object field**, write the starting value, the change you made, and the new result.
...
To answer **How do we add and remove array items**, follow the operation in order rather than treating the result as framework magic. For **How do we add and remove array items**, write the starting value, the change you made, and the new result.
