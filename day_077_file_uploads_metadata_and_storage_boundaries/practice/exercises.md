...
Use this worksheet after reading [the lesson](../day_077_file_uploads_metadata_and_storage_boundaries.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **File uploads, metadata, and storage boundaries** and uses only local, synthetic, bounded data.
