...
Use these after attempting the [exercises](exercises.md). They are specific to **File uploads, metadata, and storage boundaries** and should unblock the next thought without replacing it.
