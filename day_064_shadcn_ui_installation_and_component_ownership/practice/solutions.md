...
Use this guide after attempting [the exercises](exercises.md). It reviews the decisions for **shadcn/ui installation and component ownership**; it is not a copied answer key.
