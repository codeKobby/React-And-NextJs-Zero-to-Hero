...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_064_shadcn_ui_installation_and_component_ownership.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is shadcn/ui?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why does it copy component source into the project?**.
...
7. The comparison table distinguishes **What is shadcn/ui?** from **Why does it copy component source into the project?** by responsibility, lifetime, and direction of data flow.
