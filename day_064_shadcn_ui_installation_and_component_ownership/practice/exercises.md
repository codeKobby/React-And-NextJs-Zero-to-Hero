...
Use this worksheet after reading [the lesson](../day_064_shadcn_ui_installation_and_component_ownership.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **shadcn/ui installation and component ownership** and uses only local, synthetic, bounded data.
