...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_064_shadcn_ui_installation_and_component_ownership.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is shadcn/ui?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is shadcn/ui?** and **Why does it copy component source into the project?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
