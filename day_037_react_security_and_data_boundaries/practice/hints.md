...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_037_react_security_and_data_boundaries.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What does React escape?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What does React escape?** and **Why is dangerouslySetInnerHTML dangerous?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
