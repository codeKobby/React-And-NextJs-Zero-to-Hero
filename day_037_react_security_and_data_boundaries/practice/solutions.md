...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_037_react_security_and_data_boundaries.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What does React escape?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **Why is dangerouslySetInnerHTML dangerous?**.
...
7. The comparison table distinguishes **What does React escape?** from **Why is dangerouslySetInnerHTML dangerous?** by responsibility, lifetime, and direction of data flow.
