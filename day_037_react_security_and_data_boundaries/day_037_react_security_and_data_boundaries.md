...
| --- | --- |
| `XSS` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `escaping` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `dangerouslySetInnerHTML` | A term you will use in this lesson; test it in the examples before memorizing it. |
...
| `trust boundary` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What does React escape?

Start with the ordinary-language question: **What does React escape?**. In **React security and data boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why is dangerouslySetInnerHTML dangerous?**. In **React security and data boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Where do secrets belong?

Start with the ordinary-language question: **Where do secrets belong?**. In **React security and data boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How should user input be validated?

Start with the ordinary-language question: **How should user input be validated?**. In **React security and data boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
