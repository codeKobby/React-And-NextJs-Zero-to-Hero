...
| --- | --- |
| `JSX` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `fragment` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `className` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `expression` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `component name` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `escaping` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is JSX?

Start with the ordinary-language question: **What is JSX?**. In **JSX and the rules of markup**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Why must JSX have one returned root?**. In **JSX and the rules of markup**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do expressions enter JSX?

Start with the ordinary-language question: **How do expressions enter JSX?**. In **JSX and the rules of markup**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do we keep markup accessible?

Start with the ordinary-language question: **How do we keep markup accessible?**. In **JSX and the rules of markup**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
