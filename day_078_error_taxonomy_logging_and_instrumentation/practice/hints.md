...
1. Read the short problem statement for error taxonomy, logging, and instrumentation and say what the page or program should do.
...
4. Change one input for What is the difference between an expected and unexpected error?. Keep every other line the same.
5. For What should a structured log contain?, try the normal case first. Then try one empty or bad value.
...
8. Use invented local data while you try Why use a request ID?.
