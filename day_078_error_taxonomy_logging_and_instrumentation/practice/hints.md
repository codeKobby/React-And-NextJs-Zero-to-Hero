...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_078_error_taxonomy_logging_and_instrumentation.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is the difference between an expected and unexpected error?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is the difference between an expected and unexpected error?** and **What should a structured log contain?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
