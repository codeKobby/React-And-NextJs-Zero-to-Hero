...
Use this guide after attempting [the exercises](exercises.md). A solution is evidence and reasoning, not a copied file. Compare your work with the [lesson](../day_078_error_taxonomy_logging_and_instrumentation.md), then improve the explanation if your code works for the wrong reason.

## Review checkpoints

1. The definition of **What is the difference between an expected and unexpected error?** names an observable rule and points to a concrete lesson example.
...
4. The normal alternative changes one input and preserves the rule for **What should a structured log contain?**.
...
7. The comparison table distinguishes **What is the difference between an expected and unexpected error?** from **What should a structured log contain?** by responsibility, lifetime, and direction of data flow.
