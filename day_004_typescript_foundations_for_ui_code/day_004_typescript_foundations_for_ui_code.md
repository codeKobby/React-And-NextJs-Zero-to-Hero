...
To answer **How do unions describe real UI states**, follow the operation in order rather than treating the result as framework magic. For **How do unions describe real UI states**, write the starting value, the change you made, and the new result.
...
5. Add one simple edge case for **How do unions describe real UI states?**, such as an empty or invalid value.
