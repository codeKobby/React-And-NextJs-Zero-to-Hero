...
4. Change exactly one input related to What is a class component?; keep the rule fixed.
5. For What is a function component?, decide the normal and boundary behavior before coding.
...
8. Keep the data local and synthetic while you test How do lifecycle methods map to Hooks?.
9. Assert a visible result or public contract rather than a private implementation detail.
10. Use the same fixture to apply function components versus class components to a local case dashboard built from a shell, summary, list, and card.
