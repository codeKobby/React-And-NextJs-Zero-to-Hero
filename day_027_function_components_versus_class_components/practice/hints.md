...
Use these after attempting the [exercises](exercises.md). They are specific to **Function components versus class components** and should unblock the next thought without replacing it.
