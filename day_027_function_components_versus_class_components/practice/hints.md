...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_027_function_components_versus_class_components.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is a class component?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is a class component?** and **What is a function component?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
