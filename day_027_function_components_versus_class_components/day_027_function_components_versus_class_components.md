...
| --- | --- |
| `class component` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `function component` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `render` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `this` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `lifecycle` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `migration` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is a class component?

Start with the ordinary-language question: **What is a class component?**. In **Function components versus class components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **What is a function component?**. In **Function components versus class components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do lifecycle methods map to Hooks?

Start with the ordinary-language question: **How do lifecycle methods map to Hooks?**. In **Function components versus class components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### When must we read class code?

Start with the ordinary-language question: **When must we read class code?**. In **Function components versus class components**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
