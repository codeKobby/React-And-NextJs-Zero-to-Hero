...
Use this worksheet after reading [the lesson](../day_053_authentication_and_authorization_boundaries.md). Start with the [course README](../../README.md), confirm the [setup guide](../../SETUP.md), and choose the local fixture from the [examples guide](../../examples/README.md). This worksheet is designed for **Authentication and authorization boundaries** and uses only local, synthetic, bounded data.
