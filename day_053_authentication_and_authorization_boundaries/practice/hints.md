...
These hints are deliberately specific enough to unblock you but not to replace the attempt. Use the [lesson](../day_053_authentication_and_authorization_boundaries.md) and [setup guide](../../SETUP.md) first.

## Hints

1. Use the word **What is the difference between authentication and authorization?** in your definition, then connect it to an observable input and output rather than a dictionary slogan.
...
7. **What is the difference between authentication and authorization?** and **Where should session checks run?** may be related without being interchangeable. Compare who creates the value and who is allowed to change it.
