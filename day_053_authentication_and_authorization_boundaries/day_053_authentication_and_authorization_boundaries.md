...
| `session` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `cookie` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `CSRF` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `role` | A term you will use in this lesson; test it in the examples before memorizing it. |
| `least privilege` | A term you will use in this lesson; test it in the examples before memorizing it. |

## Topics

### What is the difference between authentication and authorization?

Start with the ordinary-language question: **What is the difference between authentication and authorization?**. In **Authentication and authorization boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
...
Start with the ordinary-language question: **Where should session checks run?**. In **Authentication and authorization boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### Why is a hidden button not authorization?

Start with the ordinary-language question: **Why is a hidden button not authorization?**. In **Authentication and authorization boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.

A beginner mistake is to copy the spelling without understanding the runtime. Instead, say the rule aloud, write a prediction, run the example, and compare the result. Keep the prediction even when it is wrong; the mismatch tells you which assumption needs repair.

### How do roles limit data?

Start with the ordinary-language question: **How do roles limit data?**. In **Authentication and authorization boundaries**, this topic is not a slogan. It is a decision you can observe in a small program. Read the next example slowly, name the input, the operation, the output, and the boundary that prevents the code from doing more than intended. Then change one value and explain which line noticed the change.
